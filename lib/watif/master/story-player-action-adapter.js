...
export default class StoryPlayerActionAdapter {
  ...
  _exportMethods () {
    const api = {
      selectItem: this.handlePlayerItemSelected,
  ...
  handlePlayerItemSelected (subjectItemId) {
    this._callbacks.selectItem(subjectItemId)
  }

  handlePlayerVerbSelected (subjectItemId, verbId, targetItemId) {
    this._callbacks.selectVerb(subjectItemId, verbId, targetItemId)
  }
